...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(passwords.getFileName());
    ...
    public static Path downloadFile(String urlString, Path downloadDirectory) throws IOException {
       ...
       // Files.createFile(downloadDirectory,)
        Files.copy(tempFile,downloadDirectory);

        //File file = new File(String.valueOf(downloadDirectory));
        FileReader reader = new FileReader(String.valueOf(tempFile));
      //  FileWriter writer = new FileWriter(String.valueOf(downloadDirectory)+"/"+);
